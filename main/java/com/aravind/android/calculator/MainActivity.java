/*Android app developed by Subramanian T*/
/*Play Store link is available in Documentation Section*/
...
public class MainActivity extends AppCompatActivity {
    ...
    public void ftanh(View view)
    {
        ...
        {
            if (editor.getText().length() == 0 && snum < 1) {
                Toast.makeText(this, "Enter number to calculate its hyperbolic tan value", Toast.LENGTH_SHORT).show();
            } else if (snum < 1) {
                double ypxi;
                powtmp = Double.parseDouble(editor.getText().toString());
                if (ineg == 1) {
                ...
                if (powtmp > 999999999999999.9 || powtmp < (-999999999999999.9)) {
                    DecimalFormat df = new DecimalFormat("###############.#########E0");
                    symr.setText("" + symtxtr + "tanh(" + df.format(ypxi) + ")");
                } else {
                    DecimalFormat df = new DecimalFormat("###############.###################");
                    symr.setText("" + symtxtr + "tanh(" + df.format(ypxi) + ")");
                }
        ...
        {
            if (editor.getText().length() == 0 && snum < 1) {
                Toast.makeText(this, "Enter number to calculate its inverse tan value", Toast.LENGTH_SHORT).show();
            } else if (snum < 1) {
                double ypxi;
                powtmp = Double.parseDouble(editor.getText().toString());
                if (ineg == 1) {
                ...
                if (powtmp > 999999999999999.9 || powtmp < (-999999999999999.9)) {
                    DecimalFormat df = new DecimalFormat("###############.#########E0");
                    symr.setText("" + symtxtr + "tan⁻¹(" + df.format(ypxi) + ")");
                } else {
                    DecimalFormat df = new DecimalFormat("###############.###################");
                    symr.setText("" + symtxtr + "tan⁻¹(" + df.format(ypxi) + ")");
                }
    ...
    public void fcos(View view)
    {
        try{
        TextView editor = (TextView) findViewById(R.id.tv);
        if(editor.getText().length()==0 && snum<1)
        {
            Toast.makeText(this, "Enter number to calculate its cos value", Toast.LENGTH_SHORT).show();
        }
        else if(snum<1)
        {
            double ypxi;
    ...
    public void ftan(View view)
    {
        try{
        TextView editor = (TextView) findViewById(R.id.tv);
        if(editor.getText().length()==0 && snum<1)
        {
            Toast.makeText(this, "Enter number to calculate its tan value", Toast.LENGTH_SHORT).show();
        }
        else if(snum<1)
        {
            double ypxi;
    ...
    private double factori(double orial)
    {
        if(orial==0)
         return 1;
        else
           return (orial*factori(orial-1));
    }

    public void ffact(View view)
    {
        try {
            TextView editor = (TextView) findViewById(R.id.tv);
            double temf = Double.parseDouble(editor.getText().toString());
            if (ineg == 1 || editor.getText().toString().contains(".")) {
                Toast.makeText(this, "Invalid Input", Toast.LENGTH_SHORT).show();
            } else if (temf > 175) {
                Toast.makeText(this, "Result exceeds space available", Toast.LENGTH_SHORT).show();
            } else if (editor.getText().length() == 0 && snum < 1) {
                Toast.makeText(this, "Enter value to calculate its Factorial", Toast.LENGTH_SHORT).show();
            } else if (snum < 1) {
                double ypxi;
                powtmp = Double.parseDouble(editor.getText().toString());
                ypxi = powtmp;
    ...
    public void frot(View view)
    {
        ...
        {
            Toast.makeText(this, "Enter value to calculate its root", Toast.LENGTH_SHORT).show();
        }
        else if(snum<1)
        {
            double ypxi;
    ...
    public void fln(View view)
    {
        try{
        TextView editor = (TextView) findViewById(R.id.tv);
        Toast.makeText(this, "log with base e", Toast.LENGTH_SHORT).show();
        if(ineg==1)
        {
            Toast.makeText(this, "Invalid Input", Toast.LENGTH_SHORT).show();
        }
        ...
        {
            Toast.makeText(this, "Enter value to calculate its ln", Toast.LENGTH_SHORT).show();
        }
        else if(snum<1)
        {
            double ypxi;
            ...
            {
                DecimalFormat df = new DecimalFormat("###############.#########E0");
                symr.setText("" +symtxtr+"ln("+ df.format(ypxi)+")");
            } else
            {
                DecimalFormat df = new DecimalFormat("###############.###################");
                symr.setText("" +symtxtr+"ln("+ df.format(ypxi)+")");
    ...
    public void flog(View view)
    {
        try{
        TextView editor = (TextView) findViewById(R.id.tv);
        Toast.makeText(this, "log with base 10", Toast.LENGTH_SHORT).show();
        if(ineg==1)
        {
            Toast.makeText(this, "Invalid Input", Toast.LENGTH_SHORT).show();
        }
        ...
        {
            Toast.makeText(this, "Enter value to calculate its log", Toast.LENGTH_SHORT).show();
        }
        else if(snum<1)
        {
            double ypxi;
            ...
            {
                DecimalFormat df = new DecimalFormat("###############.#########E0");
                symr.setText("" +symtxtr+"log("+ df.format(ypxi)+")");
            } else
            {
                DecimalFormat df = new DecimalFormat("###############.###################");
                symr.setText("" +symtxtr+"log("+ df.format(ypxi)+")");
    ...
    public void fonex(View view)
    {
        try{
        TextView editor = (TextView) findViewById(R.id.tv);
        if(editor.getText().length()==0 && snum<1)
        {
            Toast.makeText(this, "Enter value to calculate its inverse", Toast.LENGTH_SHORT).show();
        }
        else if(snum<1)
        {
            double ypxi;
            ...
            {
                DecimalFormat df = new DecimalFormat("###############.#########E0");
                symr.setText("" +symtxtr+"1/"+ df.format(ypxi));
            } else
            {
                DecimalFormat df = new DecimalFormat("###############.###################");
                symr.setText("" +symtxtr+"1/"+ df.format(ypxi));
    ...
    public void fypowx(View view)
    {
        try{
        TextView editor = (TextView) findViewById(R.id.tv);
        if(editor.getText().length()==0 && snum<1)
        {
            Toast.makeText(this, "Enter value of y first", Toast.LENGTH_SHORT).show();
        }
        else if(snum<1)
        {
            double ypxi;
    ...
    public void fepowx(View view)
    {
        try{
        TextView editor = (TextView) findViewById(R.id.tv);
        if(editor.getText().length()!=0 || snum==3)
            Toast.makeText(this, "Enter operator to continue", Toast.LENGTH_SHORT).show();
       else if(snum<1)
        {
            snum=3;
